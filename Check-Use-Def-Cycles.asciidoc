...
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[use-def symbol set]
of _a_.
If it does, then the 
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[use-def matching list]
...
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[visited symbol set]
of _a_, then
