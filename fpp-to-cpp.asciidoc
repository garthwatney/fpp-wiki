...
. `-t`: Generate templates of derived classes instead of base classes.
...
. Perform https://github.jpl.nasa.gov/bocchino/fpp/wiki/Checking-Semantics[semantic checking] on 
