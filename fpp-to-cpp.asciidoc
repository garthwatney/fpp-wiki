...
.. If the `-u` option is present and the `-t` option is not present, then these are the 
standard autocoded files (item 1.ii) plus the autocoded files for unit testing.
