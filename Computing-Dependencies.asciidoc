...
. An https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[analysis data structure]
_a_. The 
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[input file set]
...
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[scope name list]
...
.. Check the 
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[location 
specifier map]
...
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[dependency file set]
of _a_, then
...
... Otherwise add _p_ to the https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[missing dependency file set] of _a_.
