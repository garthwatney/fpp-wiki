...
. Create a fresh 
link:https://github.jpl.nasa.gov/bocchino/fpp/wiki/Analysis-Data-Structure[analysis 
data structure] _a_.
...
https://github.jpl.nasa.gov/bocchino/fpp/wiki/Computing-Dependencies[computing 
