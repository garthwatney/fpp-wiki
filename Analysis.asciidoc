...
. The set of type symbols used in the topology

. A set representing the subset of type symbols that correspond to arrays

. A set representing the subset of type symbols that correspond to enumerations

. A set representing the subset of type symbols that correspond to structs
