...
. A set of topologies representing the imported topology
definitions.

. A set of topologies representing the transitively
imported topology definitions.
...
. A set of unused port instances.
