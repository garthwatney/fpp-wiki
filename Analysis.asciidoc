...
https://github.com/nasa/fpp/wiki/Analysis-Data-Structure[here].
...
* https://github.com/nasa/fpp/wiki/Checking-Semantics[Checking Semantics]
* https://github.com/nasa/fpp/wiki/Dictionary-Construction[Dictionary Construction]
