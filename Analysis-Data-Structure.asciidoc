The https://github.com/nasa/fpp/blob/main/compiler/lib/src/main/scala/analysis/Analysis.scala[*Analysis Data Structure*] represents the results of FPP source analysis.
